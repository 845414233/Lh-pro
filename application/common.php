...
function get_fid($fid){
     $res= Db::name('user')->where('id',$fid)->value('phone');
     return $res;
}
function get_category_data($id){
    $res= Db::name('category')->where('id',$id)->value('name');
    return $res;
}
function string_short($string){
  ...
  function in_qsbank($id){
      $res= Db::name('qsbank')->where('id',$id)->value('title');
      return string_short($res);
  }