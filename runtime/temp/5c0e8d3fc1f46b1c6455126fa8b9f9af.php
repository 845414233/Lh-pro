<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\wwwroot\wap.pro.com\public/../application/admin\view\banner\banner\edit.html";i:1604905470;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" enctype="multipart/form-data" action="<?php echo url('banner/banner/edit'); ?>" method="post">
                  ...
                  <div class="layui-form-item">
                      <button type="button" class="layui-btn" id="banner" name="banner">上传图片</button>
                      <div class="layui-upload-list">
                          <img class="layui-upload-img" id="src" style="width:300px;height: 100px;">
                          <input type="hidden" name="img_src" id="imgsrc" value="<?php echo $to['img_src']; ?>">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="url" name="url"  value="<?php echo $to['url']; ?>" required=""
