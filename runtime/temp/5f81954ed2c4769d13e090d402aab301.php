<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\wwwroot\wap.pro.com\public/../application/admin\view\question\video\add.html";i:1604980394;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<?php echo url('question/video/add'); ?>" method="post" id="add">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-form-item" id ="p_show" style="display: none;">
                        <label for="L_pass" class="layui-form-label">
                            价格
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="price" name="price" required="" autocomplete="off" class="layui-input" value="">
                        </div>
                    </div>
                    <div class="layui-form-item"  >
                        <label for="L_pass" class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <input type="hidden" name="video_src" value="" id="video_src">
                        </div>
                    </div>
                    <div class="layui-form-item">
