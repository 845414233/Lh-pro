<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\wwwroot\wap.pro.com\public/../application/admin\view\product\product\edit.html";i:1605057614;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="<?php echo url('product/product/edit'); ?>" method="post" id="edit">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="amout" name="amout" required="" lay-verify=""
                           autocomplete="off" class="layui-input" value="<?php echo $to['amout']; ?>">
                </div>
                <div class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="continu_time" name="continu_time" required="" lay-verify="number|required"
                           autocomplete="off" class="layui-input" value="<?php echo $to['continu_time']; ?>">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>秒
                </div>
            </div>
            <div class="layui-form-item">
