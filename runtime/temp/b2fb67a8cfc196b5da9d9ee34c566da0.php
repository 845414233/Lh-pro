<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\wwwroot\wap.pro.com\public/../application/admin\view\category\edit.html";i:1605058500;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-weigh" class="control-label col-xs-12 col-sm-2">免费题目:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-free_qs" class="form-control" name="row[free_qs]" type="number" value="<?php echo $row['free_qs']; ?>">
        </div>
    </div>
    <div class="form-group">
