<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\wwwroot\wap.pro.com\public/../application/admin\view\notice\notice\index.html";i:1605077351;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<div class="x-nav">
          <span class="layui-breadcrumb">
            ...
            <a href="<?php echo url('notice/notice/index'); ?>">公告管理</a>
            <a>
              <cite>导航元素</cite></a>
          </span>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加公告','<?php echo url('notice/notice/add'); ?>')"><i class="layui-icon"></i>添加公告</button>
                </div>
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td><?php echo string_short($to['content']); ?></td>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑"  onclick="xadmin.open('编辑','<?php echo url('notice/notice/edit',['id'=>$to['id']]); ?>')" href="javascript:;">
