<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wwwroot\wap.pro.com\public/../application/admin\view\user\user\edit.html";i:1604884079;s:65:"D:\wwwroot\wap.pro.com\application\admin\view\layout\default.html";i:1602168706;s:62:"D:\wwwroot\wap.pro.com\application\admin\view\common\meta.html";i:1602168706;s:64:"D:\wwwroot\wap.pro.com\application\admin\view\common\script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<html class="x-admin-sm">
    ...
    <body>
                ...
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="<?php echo $to['name']; ?>">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="<?php echo $to['phone']; ?>">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>将会成为您唯一的登入名
                      </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="fid" name="phone" required="" lay-verify="number|required"
                                   autocomplete="off" class="layui-input" value="<?php echo $to['fid']; ?>">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                            <span class="x-red">*</span>将会成为您唯一的登入名
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="courses" name="courses" required=""
                                   ...
                                   value="<?php echo $to['courses']; ?>"
                                   onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\d]/g,''))" maxlength="10">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                            <span class="x-red">*</span>
                        </div>
                    </div>
                    <input type="hidden" name="id" id="id" value="<?php echo $to['id']; ?>">
                    <div class="layui-form-item">
                        <label for="L_email" class="layui-form-label">
                            <span class="x-red">*</span>vip到期时间
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" name="vip_time_out" id="vip_time_out"  value="<?php echo $to['vip_time_out']; ?>" class="layui-input"  placeholder="yyyy-MM-dd">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                            <span class="x-red">*</span>
                        </div>
        ...
        <script>
            ...
            $.post("<?php echo url('user/user/edit'); ?>",
                {
                    id:$("#id").val(),
                    fid:$("#fid").val(),
                    phone:$("#phone").val(),
